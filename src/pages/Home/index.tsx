...
export function Home() {
  ...
  // Passing state creating arrowfunction, because if the value is cycles (cycles.map), they dont capture the real value or actual value
      ...
      <form onSubmit={handleSubmit(handleCreateNewCycle)} action="">
        <FormContainer>
          ...
          <TaskInput
            ...
            // With two exclamation, just transform the result to boolean
